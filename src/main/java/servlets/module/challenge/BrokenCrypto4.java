  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateSession(ses)) {
      ...
      try {
        ...
        try {
          if (coupons.next()) {
            // Redeeming a code the customer holds is the shop's normal business. The defect
            // this level teaches is that the codes were validated in the browser by an
            ...
            // now happens here, against the server's own data.
